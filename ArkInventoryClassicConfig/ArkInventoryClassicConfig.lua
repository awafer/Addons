...
$Revision: 2333 $
$Date: 2019-03-29 23:58:50 +1100 (Fri, 29 Mar 2019) $
...
function ArkInventory.ConfigInternal( )
	...
	ArkInventory.ConfigInternalProfile( path.args.settings.args.myprofiles )
...
function ArkInventory.ConfigInternalProfile( path )
